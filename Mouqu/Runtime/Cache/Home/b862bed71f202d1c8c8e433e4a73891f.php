...
<div id="dcMain"> <!-- 当前位置 -->
    <div id="urHere">谋趣 管理中心</div>  <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;height:550px;min-height:550px;">
        <div class="warning">欢迎您，<?php echo $_SESSION['user_name'] ?>。</div>
