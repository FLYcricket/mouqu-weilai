...
<div id="dcMain">
    <!-- 当前位置 -->
    <div id="urHere">谋趣 管理中心<b>></b><strong>地址列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <div id="list"><h3>订单</h3>
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                <tr>
                    <th width="40" align="center">对应用户id</th>
                    <th width="40">姓名</th>
                ...
                <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$address): $mod = ($i % 2 );++$i;?><tr>
                        <td align="center"><?php echo ($address["userid"]); ?></td>
                        <td align="center"><?php echo ($address["name"]); ?></td>
                        <td align="center"><?php echo ($address["sex"]); ?></td>
                        <td align="center"><?php echo ($address["phone"]); ?></td>
                        <td align="center"><?php echo ($address["address"]); ?></td>
                        <td align="center"><span style="color: red "><?php echo ($address["status"]); ?></span>&nbsp;&nbsp;(1:默认地址，0:候补地址)</td>
